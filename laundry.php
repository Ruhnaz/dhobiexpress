...
$current_page = "Laundry-service";
include 'includes/header.php';?>

    <!-- Page Header Start -->
    <div class="container-fluid page-header mb-5 py-5">
        <div class="container">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Laundry Service</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb text-uppercase">
                    <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="#">Pages</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">Laundry-Service</li>
                </ol>
            </nav>
        </div>
    </div>
  ...
  <div class="container">
    <div class="row g-4">
      ...
      <div class="col-md-8 wow fadeInUp" data-wow-delay="0.1s">
        <div class="mb-4">
          <img src="images/lndry-service.jpg" class="img-fluid service-img" alt="Laundry Service">
        </div>
        <h2 class="mb-3">Premium Laundry Service</h2>
        <p>
          Experience the best laundry care with quick delivery, eco-friendly cleaning, 
          and premium quality service tailored for your needs.
        </p>
        
<p>
  Whether it’s your daily wear, formal suits, or delicate fabrics, we handle 
  each item with special care. With doorstep pickup, timely delivery, and 
  hassle-free ordering, Premium Laundry Service makes laundry the easiest part 
  of your day.
</p>

...
$current_page = "saree-wedding-care-service";
include 'includes/header.php';?>

    <!-- Page Header Start -->
    <div class="container-fluid page-header mb-5 py-5">
        <div class="container">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Saree And Wedding Care</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb text-uppercase">
                    <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="#">Pages</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">Saree-wedding Dress-care</li>
                </ol>
            </nav>
        </div>
    </div>
  ...
  <div class="container">
    <div class="row g-4">
      ...
      <div class="col-md-8 wow fadeInUp" data-wow-delay="0.1s">
        <div class="mb-4">
          <img src="images/wd-care-service.jpg" class="img-fluid service-img" alt="Laundry Service">
        </div>
        <h2 class="mb-3">Saree And Wedding Dress Care</h2>
        <p>
          Our Saree & Wedding Dress Care service is specially designed to preserve the elegance and beauty of your most treasured outfits. We understand that sarees, bridal gowns, and wedding attire are more than just garments—they hold sentimental value and represent cherished memories. That’s why we use gentle, fabric-friendly cleaning techniques and advanced stain-removal processes to protect delicate materials such as silk, chiffon, organza, velvet, and lace. Whether it’s an intricately embroidered saree, a heavily embellished bridal lehenga, or a flowing wedding gown, our expert team treats every garment with the utmost precision and care. We ensure that embellishments like zari, sequins, beads, and stones remain intact while restoring the fabric’s original freshness and shine. Beyond cleaning, we also provide finishing services like soft steaming, folding, and safe packaging to keep your outfits in perfect condition for long-term storage. With our service, you can trust that your priceless wedding wear and sarees will be preserved in their finest form, ready to be worn again for special occasions or passed down as heirlooms.
